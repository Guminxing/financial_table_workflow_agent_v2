...
| missing_rate_after_join | data_quality | error | failed | Fix close missing values before modeling. |
...
- **missing_rate_after_join**: `failed` — close missing rate must be 0; pe/pb/roe high missing is warning (low announce freq)
  - evidence: close_missing_rate=0.0067, fundamental_missing_rates={'pe': 0.8233, 'pb': 0.8233, 'roe': 0.8233}, industry_missing_rate=0.2
